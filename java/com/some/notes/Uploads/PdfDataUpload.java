...
//
//public class PdfDataUpload extends AppCompatActivity {
//
//
//    String names[] = {};
//    String courseName[] = {"B-TECH","BE COURSE","BSC COURSE","BSC(HONC)","MSE","ME","M-TECH","BCOM","BA","MBA",
//    "BA COURSE","BA(HONC)","BBA","BCOM","BA LLB","BBA LLB ","BCOM LLB","BCA"};
//    String universityName[] = {"RAJDEEP VERMA","RISHABH KUMAR"};
...
//
//    private String cheker = "", myUrl = "", saveCurrentTime, saveCurrentDate,university_name;
//    private Uri fileUri;
...
//        setContentView(R.layout.activity_image_upload_activitry);
//
...
//
//         */
//        imgUpi_id.setText("edurathore9999@okaxis");
//        upi_holder_name.setText("surender kumar");
//
...
//                {
//                    Toast.makeText(PdfDataUpload.this, "add_Course", Toast.LENGTH_SHORT).show();
//                }
//               else if (TextUtils.isEmpty(web_branch))
//               {
//                   Toast.makeText(PdfDataUpload.this, "add_branch", Toast.LENGTH_SHORT).show();
//               }
//               else if (TextUtils.isEmpty(web_test))
//               {
//                   Toast.makeText(PdfDataUpload.this, "add_test", Toast.LENGTH_SHORT).show();
//               }
//               else if (TextUtils.isEmpty(web_subject))
//               {
//                   Toast.makeText(PdfDataUpload.this, "add_subject", Toast.LENGTH_SHORT).show();
//               }
//               else if (TextUtils.isEmpty(web_semester))
//               {
//                   Toast.makeText(PdfDataUpload.this, "add_semester", Toast.LENGTH_SHORT).show();
//               }
//               else if (TextUtils.isEmpty(web_amount))
//               {
//                   Toast.makeText(PdfDataUpload.this, "add_amount", Toast.LENGTH_SHORT).show();
//               }
//               else
//                   {
//                    uploadPdf("satpalrathore001@okicici",university_name,web_Course,web_branch,web_test,web_subject,web_semester,"surender kumar",web_amount);
//                }
//
//                if (mUploadTask != null && mUploadTask.isInProgress()) {
//                    Toast.makeText(PdfDataUpload.this, "Upload in progress", Toast.LENGTH_LONG).show();
//                } else {
//
//                }
//            }
...
//                                                                                                                                                                                public void onComplete(@NonNull Task task) {
//                                                                                                                                                                                    if (task.isSuccessful()) {
//                                                                                                                                                                                        Toast.makeText(PdfDataUpload.this, "upload successfully", Toast.LENGTH_SHORT).show();
//
//                                                                                                                                                                                        if (task.isSuccessful()) {
//
//                                                                                                                                                                                            final String messagePushID11 = RootRef.push().getKey();
...
//
//                        Toast.makeText(PdfDataUpload.this, e.getMessage(), Toast.LENGTH_SHORT).show();
//                    }
//                });
//
...
//                });
//            } else {
//                Toast.makeText(PdfDataUpload.this, "No file selected", Toast.LENGTH_SHORT).show();
//            }
//        }
//    }
//}